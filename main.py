...
if gross_income > constants.medicare_premium_wage:
    medicare_paid = round(
        gross_income * (constants.medicare_rate + constants.medicare_premium_rate), 2)
else:
    medicare_paid = round(gross_income * constants.medicare_rate, 2)
...
income_after_tax = round(
    (gross_income - total_taxes_paid - medicare_paid - social_security_paid), 2)
